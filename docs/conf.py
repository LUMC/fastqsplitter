...
package = pkg_resources.get_distribution("fastqsplitter")
...
htmlhelp_basename = 'fastqsplitterdoc'
...
latex_documents = [
    (master_doc, 'fastqsplitter.tex', 'fastqsplitter Documentation',
...
man_pages = [
    (master_doc, 'fastqsplitter', 'fastqsplitter Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fastqsplitter', 'fastqsplitter Documentation',
     author, 'fastqsplitter', 'One line description of project.',
     'Miscellaneous'),
]
